...
--------------------------------------------------------------------- */
DATA.COMMUNITIES = [
  { id: "gulch", name: "Silicon Gulch", state: "NV", x: 16, y: 46,
  ...
  { id: "aquifer", name: "Aquifer Acres", state: "AZ", x: 23, y: 63,
  ...
  { id: "coalburg", name: "Coalburg", state: "WV", x: 72, y: 43,
  ...
  { id: "rustbelt", name: "Rustbelt Junction", state: "OH", x: 67, y: 35,
  ...
  { id: "cornfield", name: "Cornfield County", state: "IA", x: 52, y: 32,
  ...
  { id: "taxhaven", name: "Tax Haven Cove", state: "DE", x: 83, y: 39,
  ...
  { id: "oceanpoint", name: "Ocean-Cooled Point", state: "OR", x: 11, y: 17,
  ...
  { id: "nuketown", name: "Nuclear-Adjacent Nowhere", state: "NM", x: 28, y: 58,
  ...
  { id: "senatortown", name: "Senator's Hometown", state: "TX", x: 45, y: 68,
  ...
  { id: "collegetown", name: "Old State College Town", state: "MA", x: 87, y: 21,
  ...
  { id: "permafrost", name: "Permafrost Junction", state: "AK", x: 9, y: 80,
  ...
  { id: "sunbelt", name: "Sunbelt Sprawl", state: "FL", x: 79, y: 79,
